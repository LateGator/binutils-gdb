...
START_RELOC_NUMBERS (elf_mips_reloc_type)
  ...
  /* N64 RSP relocations.  */
  RELOC_NUMBER (R_MIPS_RSP70, 67)
  RELOC_NUMBER (R_MIPS_RSP71, 68)
  RELOC_NUMBER (R_MIPS_RSP72, 69)
  RELOC_NUMBER (R_MIPS_RSP73, 70)
  RELOC_NUMBER (R_MIPS_RSP74, 71)
  RELOC_NUMBER (R_MIPS_RSP16, 72)
  FAKE_RELOC (R_MIPS_max, 73)
...
#define EF_MIPS_MACH_RSP	0x008f0000
...
#define E_MIPS_MACH_RSP       EF_MIPS_MACH_RSP 
