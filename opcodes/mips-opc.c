...
decode_mips_operand (const char *p)
{
  switch (p[0])
    ...
    case '-':
      switch (p[1])
	{
	case '0': INT_ADJ (7, 0, 63, 0, false);
	case '1': INT_ADJ (7, 0, 63, 1, false);
	case '2': INT_ADJ (7, 0, 63, 2, false);
	case '3': INT_ADJ (7, 0, 63, 3, false);
	case '4': INT_ADJ (7, 0, 63, 4, false);
	case 'a': INT_ADJ (19, 0, 262143, 2, false);
	case 'b': INT_ADJ (18, 0, 131071, 3, false);
	case 'd': SPECIAL (0, 0, REPEAT_DEST_REG);
	case 'e': SPECIAL (4, 7, IMM_INDEX);
	case 'f': SPECIAL (5, 11, IMM_INDEX);
	...
	case 'C': REG (5, 11, RSP_VEC_CTRL);
	case 'E': SPECIAL (9, 16, REG_RSP_INDEX);
	case 'F': SPECIAL (9, 6, REG_RSP_INDEX);
	case 'X': REG (5, 6, RSP_VEC);
	case 'Y': OPTIONAL_REG (5, 11, RSP_VEC);
	case 'Z': REG (5, 16, RSP_VEC);
	}
      break;
...
/* N64 RSP pinfo2 flags.  */
#define SPVU	INSN2_RSP_VU
#define LD3	INSN2_LD_3
...
/* N64 RSP specific instructions.  N64 RSP redefines the Coprocessor 2 instructions.  */
{"lbv",			"-Z-e,-0(b)",	0xc8000000, 0xfc00f800,	WR_1|RD_4|CLD|WR_C2,	LD3,		RSP,		0,	0 },
{"lbv",			"-Z-e,A(b)",	0,    (int) M_LBV_AB,	INSN_MACRO,		LD3,		RSP,		0,	0 },
{"lsv",			"-Z-e,-1(b)",	0xc8000800, 0xfc00f800,	WR_1|RD_4|CLD|WR_C2,	LD3,		RSP,		0,	0 },
{"lsv",			"-Z-e,A(b)",	0,    (int) M_LSV_AB,	INSN_MACRO,		LD3,		RSP,		0,	0 },
{"llv",			"-Z-e,-2(b)",	0xc8001000, 0xfc00f800,	WR_1|RD_4|CLD|WR_C2,	LD3,		RSP,		0,	0 },
{"llv",			"-Z-e,A(b)",	0,    (int) M_LLV_AB,	INSN_MACRO,		LD3,		RSP,		0,	0 },
{"ldv",			"-Z-e,-3(b)",	0xc8001800, 0xfc00f800,	WR_1|RD_4|CLD|WR_C2,	LD3,		RSP,		0,	0 },
{"ldv",			"-Z-e,A(b)",	0,    (int) M_LDV_AB,	INSN_MACRO,		LD3,		RSP,		0,	0 },
{"lqv",			"-Z-e,-4(b)",	0xc8002000, 0xfc00f800,	WR_1|RD_4|CLD|WR_C2,	LD3,		RSP,		0,	0 },
{"lqv",			"-Z-e,A(b)",	0,    (int) M_LQV_AB,	INSN_MACRO,		LD3,		RSP,		0,	0 },
{"lrv",			"-Z-e,-4(b)",	0xc8002800, 0xfc00f800,	WR_1|RD_4|CLD|WR_C2,	LD3,		RSP,		0,	0 },
{"lrv",			"-Z-e,A(b)",	0,    (int) M_LRV_AB,	INSN_MACRO,		LD3,		RSP,		0,	0 },
{"lpv",			"-Z-e,-3(b)",	0xc8003000, 0xfc00f800,	WR_1|RD_4|CLD|WR_C2,	LD3,		RSP,		0,	0 },
{"lpv",			"-Z-e,A(b)",	0,    (int) M_LPV_AB,	INSN_MACRO,		LD3,		RSP,		0,	0 },
{"luv",			"-Z-e,-3(b)",	0xc8003800, 0xfc00f800,	WR_1|RD_4|CLD|WR_C2,	LD3,		RSP,		0,	0 },
{"luv",			"-Z-e,A(b)",	0,    (int) M_LUV_AB,	INSN_MACRO,		LD3,		RSP,		0,	0 },
{"lhv",			"-Z-e,-4(b)",	0xc8004000, 0xfc00f800,	WR_1|RD_4|CLD|WR_C2,	LD3,		RSP,		0,	0 },
{"lhv",			"-Z-e,A(b)",	0,    (int) M_LHV_AB,	INSN_MACRO,		LD3,		RSP,		0,	0 },
{"lfv",			"-Z-e,-4(b)",	0xc8004800, 0xfc00f800,	WR_1|RD_4|CLD|WR_C2,	LD3,		RSP,		0,	0 },
{"lfv",			"-Z-e,A(b)",	0,    (int) M_LFV_AB,	INSN_MACRO,		LD3,		RSP,		0,	0 },
{"lwv",/*!*/		"-Z-e,-4(b)",	0xc8005000, 0xfc00f800,	WR_1|RD_4|CLD|WR_C2,	LD3,		RSP,		0,	0 },
{"lwv",/*!*/		"-Z-e,A(b)",	0,    (int) M_LWV_AB,	INSN_MACRO,		LD3,		RSP,		0,	0 },
{"ltv",			"-Z-e,-4(b)",	0xc8005800, 0xfc00f800,	WR_1|RD_4|CLD|WR_C2,	LD3,		RSP,		0,	0 },
{"ltv",			"-Z-e,A(b)",	0,    (int) M_LTV_AB,	INSN_MACRO,		LD3,		RSP,		0,	0 },
{"sbv",			"-Z-e,-0(b)",	0xe8000000, 0xfc00f800,	RD_1|RD_4|SM|RD_C2,	0,		RSP,		0,	0 },
{"sbv",			"-Z-e,A(b)",	0,    (int) M_SBV_AB,	INSN_MACRO,		0,		RSP,		0,	0 },
{"ssv",			"-Z-e,-1(b)",	0xe8000800, 0xfc00f800,	RD_1|RD_4|SM|RD_C2,	0,		RSP,		0,	0 },
{"ssv",			"-Z-e,A(b)",	0,    (int) M_SSV_AB,	INSN_MACRO,		0,		RSP,		0,	0 },
{"slv",			"-Z-e,-2(b)",	0xe8001000, 0xfc00f800,	RD_1|RD_4|SM|RD_C2,	0,		RSP,		0,	0 },
{"slv",			"-Z-e,A(b)",	0,    (int) M_SLV_AB,	INSN_MACRO,		0,		RSP,		0,	0 },
{"sdv",			"-Z-e,-3(b)",	0xe8001800, 0xfc00f800,	RD_1|RD_4|SM|RD_C2,	0,		RSP,		0,	0 },
{"sdv",			"-Z-e,A(b)",	0,    (int) M_SDV_AB,	INSN_MACRO,		0,		RSP,		0,	0 },
{"sqv",			"-Z-e,-4(b)",	0xe8002000, 0xfc00f800,	RD_1|RD_4|SM|RD_C2,	0,		RSP,		0,	0 },
{"sqv",			"-Z-e,A(b)",	0,    (int) M_SQV_AB,	INSN_MACRO,		0,		RSP,		0,	0 },
{"srv",			"-Z-e,-4(b)",	0xe8002800, 0xfc00f800,	RD_1|RD_4|SM|RD_C2,	0,		RSP,		0,	0 },
{"srv",			"-Z-e,A(b)",	0,    (int) M_SRV_AB,	INSN_MACRO,		0,		RSP,		0,	0 },
{"spv",			"-Z-e,-3(b)",	0xe8003000, 0xfc00f800,	RD_1|RD_4|SM|RD_C2,	0,		RSP,		0,	0 },
{"spv",			"-Z-e,A(b)",	0,    (int) M_SPV_AB,	INSN_MACRO,		0,		RSP,		0,	0 },
{"suv",			"-Z-e,-3(b)",	0xe8003800, 0xfc00f800,	RD_1|RD_4|SM|RD_C2,	0,		RSP,		0,	0 },
{"suv",			"-Z-e,A(b)",	0,    (int) M_SUV_AB,	INSN_MACRO,		0,		RSP,		0,	0 },
{"shv",			"-Z-e,-4(b)",	0xe8004000, 0xfc00f800,	RD_1|RD_4|SM|RD_C2,	0,		RSP,		0,	0 },
{"shv",			"-Z-e,A(b)",	0,    (int) M_SHV_AB,	INSN_MACRO,		0,		RSP,		0,	0 },
{"sfv",			"-Z-e,-4(b)",	0xe8004800, 0xfc00f800,	RD_1|RD_4|SM|RD_C2,	0,		RSP,		0,	0 },
{"sfv",			"-Z-e,A(b)",	0,    (int) M_SFV_AB,	INSN_MACRO,		0,		RSP,		0,	0 },
{"swv",			"-Z-e,-4(b)",	0xe8005000, 0xfc00f800,	RD_1|RD_4|SM|RD_C2,	0,		RSP,		0,	0 },
{"swv",			"-Z-e,A(b)",	0,    (int) M_SWV_AB,	INSN_MACRO,		0,		RSP,		0,	0 },
{"stv",			"-Z-e,-4(b)",	0xe8005800, 0xfc00f800,	RD_1|RD_4|SM|RD_C2,	0,		RSP,		0,	0 },
{"stv",			"-Z-e,A(b)",	0,    (int) M_STV_AB,	INSN_MACRO,		0,		RSP,		0,	0 },
{"vmulf",		"-X,-Y,-E",	0x4a000000, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
/* vmulu is lower in the table.  */
{"vrndp",		"-X,-Y,-E",	0x4a000002, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
/* vmulq is lower in the table.  */
{"vmudl",		"-X,-Y,-E",	0x4a000004, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vmudm",		"-X,-Y,-E",	0x4a000005, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vmudn",		"-X,-Y,-E",	0x4a000006, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vmudh",		"-X,-Y,-E",	0x4a000007, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vmacf",		"-X,-Y,-E",	0x4a000008, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vmacu",		"-X,-Y,-E",	0x4a000009, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vrndn",		"-X,-Y,-E",	0x4a00000a, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vmacq",		"-X,-Y,-E",	0x4a00000b, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vmadl",		"-X,-Y,-E",	0x4a00000c, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vmadm",		"-X,-Y,-E",	0x4a00000d, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vmadn",		"-X,-Y,-E",	0x4a00000e, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vmadh",		"-X,-Y,-E",	0x4a00000f, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
/* vadd is lower in the table.  */
/* vsub is lower in the table.  */
{"vsut",/*!*/		"-X,-Y,-E",	0x4a000012, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
/* vabs is lower in the table.  */
{"vaddc",		"-X,-Y,-E",	0x4a000014, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vsubc",		"-X,-Y,-E",	0x4a000015, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vaddb",/*!*/		"-X,-Y,-E",	0x4a000016, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vsubb",/*!*/		"-X,-Y,-E",	0x4a000017, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vaccb",/*!*/		"-X,-Y,-E",	0x4a000018, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vsucb",/*!*/		"-X,-Y,-E",	0x4a000019, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vsad",/*!*/		"-X,-Y,-E",	0x4a00001a, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vsac",/*!*/		"-X,-Y,-E",	0x4a00001b, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vsum",/*!*/		"-X,-Y,-E",	0x4a00001c, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vsar",		"-X,-Y,-E",	0x4a00001d, 0xfe00003f,	WR_1,			SPVU|LD3,	RSP,		0,	0 },
{"vacc",/*!*/		"-X,-Y,-E",	0x4a00001e, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vsuc",/*!*/		"-X,-Y,-E",	0x4a00001f, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vlt",			"-X,-Y,-E",	0x4a000020, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"veq",			"-X,-Y,-E",	0x4a000021, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vne",			"-X,-Y,-E",	0x4a000022, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vge",			"-X,-Y,-E",	0x4a000023, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vcl",			"-X,-Y,-E",	0x4a000024, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vch",			"-X,-Y,-E",	0x4a000025, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vcr",			"-X,-Y,-E",	0x4a000026, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vmrg",		"-X,-Y,-E",	0x4a000027, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vand",		"-X,-Y,-E",	0x4a000028, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vnand",		"-X,-Y,-E",	0x4a000029, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vor",			"-X,-Y,-E",	0x4a00002a, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vnor",		"-X,-Y,-E",	0x4a00002b, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vxor",		"-X,-Y,-E",	0x4a00002c, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vnxor",		"-X,-Y,-E",	0x4a00002d, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"v056",/*!*/		"-X,-Y,-E",	0x4a00002e, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"v057",/*!*/		"-X,-Y,-E",	0x4a00002f, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vrcp",		"-F,-E",	0x4a000030, 0xfe00803f,	WR_1|RD_2,		SPVU|LD3,	RSP,		0,	0 },
{"vrcpl",		"-F,-E",	0x4a000031, 0xfe00803f,	WR_1|RD_2,		SPVU|LD3,	RSP,		0,	0 },
{"vrcph",		"-F,-E",	0x4a000032, 0xfe00803f,	WR_1|RD_2,		SPVU|LD3,	RSP,		0,	0 },
{"vmov",		"-F,-E",	0x4a000033, 0xfe00803f,	WR_1|RD_2,		SPVU|LD3,	RSP,		0,	0 },
{"vrsq",		"-F,-E",	0x4a000034, 0xfe00803f,	WR_1|RD_2,		SPVU|LD3,	RSP,		0,	0 },
{"vrsql",		"-F,-E",	0x4a000035, 0xfe00803f,	WR_1|RD_2,		SPVU|LD3,	RSP,		0,	0 },
{"vrsqh",		"-F,-E",	0x4a000036, 0xfe00803f,	WR_1|RD_2,		SPVU|LD3,	RSP,		0,	0 },
/* vnop is lower in the table.  */
{"vextt",/*!*/		"-X,-Y,-E",	0x4a000038, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vextq",/*!*/		"-X,-Y,-E",	0x4a000039, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vextn",/*!*/		"-X,-Y,-E",	0x4a00003a, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"v073",/*!*/		"-X,-Y,-E",	0x4a00003b, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vinst",/*!*/		"-X,-Y,-E",	0x4a00003c, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vinsq",/*!*/		"-X,-Y,-E",	0x4a00003d, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vinsn",/*!*/		"-X,-Y,-E",	0x4a00003e, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	0 },
{"vnull",/*!*/		"",		0x4a00003f, 0xffffffff,	CP,			SPVU|LD3,	RSP,		0,	0 },
/* m[tf]c2 are at the bottom of the table.  */

/* R5900 VU0 Macromode instructions. */
{"vabs",		"+7+K,+6+K",	  0x4a0001fd, 0xfe0007ff,	CP,		VU0CH,		VU0,		0,	RSP },
{"vabs",		"-X,-Y,-E",	  0x4a000013, 0xfe00003f,	WR_1|RD_2|RD_3,	SPVU|LD3,	RSP,		0,	VU0 },
{"vadd",		"+5+K,+6+K,+7+K", 0x4a000028, 0xfe00003f,	CP,		VU0CH,		VU0,		0,	RSP },
{"vadd",		"-X,-Y,-E",	  0x4a000010, 0xfe00003f,	WR_1|RD_2|RD_3,	SPVU|LD3,	RSP,		0,	VU0 },
...
{"vmulq",		"+5+K,+6+K,+q",	  0x4a00001c, 0xfe1f003f,	CP,		VU0CH,		VU0,		0,	RSP },
{"vmulq",		"-X,-Y,-E",	  0x4a000003, 0xfe00003f,	WR_1|RD_2|RD_3,	SPVU|LD3,	RSP,		0,	VU0 },
...
{"vnop",		"",		  0x4a0002ff, 0xffffffff,	CP,		0,		VU0,		0,	RSP },
{"vnop",		"",		  0x4a000037, 0xffffffff,	CP,		SPVU|LD3,	RSP,		0,	VU0 },
...
{"vsub",		"+5+K,+6+K,+7+K", 0x4a00002c, 0xfe00003f,	CP,		VU0CH,		VU0,		0,	RSP },
{"vsub",		"-X,-Y,-E",	  0x4a000011, 0xfe00003f,	WR_1|RD_2|RD_3,	SPVU|LD3,	RSP,		0,	VU0 },
...
{"abs.s",		"D,V",		0x46000005, 0xffff003f,	WR_1|RD_2|FP_S,		0,		I1,		0,	RSP },
{"abs.d",		"D,V",		0x46200005, 0xffff003f,	WR_1|RD_2|FP_D,		0,		I1,		0,	RSP|SF },
...
{"add.s",		"D,V,T",	0x46000000, 0xffe0003f,	WR_1|RD_2|RD_3|FP_S,	0,		I1,		0,	RSP },
{"add.d",		"D,V,T",	0x46200000, 0xffe0003f,	WR_1|RD_2|RD_3|FP_D,	0,		I1,		0,	RSP|SF },
...
{"bc1f",		"p",		0x45000000, 0xffff0000,	RD_CC|CBD|FP_S,		0,		I1,		0,	RSP|I37 },
...
{"bc1t",		"p",		0x45010000, 0xffff0000,	RD_CC|CBD|FP_S,		0,		I1,		0,	RSP|I37 },
...
{"c.f.d",		"S,T",		0x46200030, 0xffe007ff,	RD_1|RD_2|WR_CC|FP_D,	0,		I1,		0,	RSP|SF|I37 },
{"c.f.d",		"M,S,T",	0x46200030, 0xffe000ff, RD_2|RD_3|WR_CC|FP_D,   0,		I4_32,		0,	I37 },
{"c.f.s",		"S,T",      	0x46000030, 0xffe007ff, RD_1|RD_2|WR_CC|FP_S,   0,		I1,		0,	RSP|I37 },
...
{"c.un.d",		"S,T",		0x46200031, 0xffe007ff,	RD_1|RD_2|WR_CC|FP_D,	0,		I1,		0,	RSP|SF|I37 },
{"c.un.d",		"M,S,T",	0x46200031, 0xffe000ff, RD_2|RD_3|WR_CC|FP_D,   0,		I4_32,		0,	I37 },
{"c.un.s",		"S,T",		0x46000031, 0xffe007ff, RD_1|RD_2|WR_CC|FP_S,   0,		I1,		0,	RSP|EE|I37 },
...
{"c.eq.d",		"S,T",		0x46200032, 0xffe007ff,	RD_1|RD_2|WR_CC|FP_D,	0,		I1,		0,	RSP|SF|I37 },
{"c.eq.d",		"M,S,T",	0x46200032, 0xffe000ff, RD_2|RD_3|WR_CC|FP_D,   0,		I4_32,		0,	I37 },
{"c.eq.s",		"S,T",		0x46000032, 0xffe007ff, RD_1|RD_2|WR_CC|FP_S,   0,		I1,		0,	RSP|I37 },
...
{"c.ueq.d",		"S,T",		0x46200033, 0xffe007ff,	RD_1|RD_2|WR_CC|FP_D,	0,		I1,		0,	RSP|SF|I37 },
{"c.ueq.d",		"M,S,T",	0x46200033, 0xffe000ff, RD_2|RD_3|WR_CC|FP_D,   0,		I4_32,		0,	I37 },
{"c.ueq.s",		"S,T",		0x46000033, 0xffe007ff, RD_1|RD_2|WR_CC|FP_S,   0,		I1,		0,	RSP|EE|I37 },
...
{"c.olt.d",		"S,T",		0x46200034, 0xffe007ff, RD_1|RD_2|WR_CC|FP_D,   0,		I1,		0,	RSP|SF|I37 },
{"c.olt.d",		"M,S,T",	0x46200034, 0xffe000ff, RD_2|RD_3|WR_CC|FP_D,   0,		I4_32,		0,	I37 },
{"c.olt.s",		"S,T",		0x46000034, 0xffe007ff,	RD_1|RD_2|WR_CC|FP_S,	0,		I1,		0,	RSP|EE|I37 },
...
{"c.ult.d",		"S,T",		0x46200035, 0xffe007ff,	RD_1|RD_2|WR_CC|FP_D,	0,		I1,		0,	RSP|SF|I37 },
{"c.ult.d",		"M,S,T",	0x46200035, 0xffe000ff, RD_2|RD_3|WR_CC|FP_D,   0,		I4_32,		0,	I37 },
{"c.ult.s",		"S,T",		0x46000035, 0xffe007ff, RD_1|RD_2|WR_CC|FP_S,   0,		I1,		0,	RSP|EE|I37 },
...
{"c.ole.d",		"S,T",		0x46200036, 0xffe007ff, RD_1|RD_2|WR_CC|FP_D,   0,		I1,		0,	RSP|SF|I37 },
{"c.ole.d",		"M,S,T",	0x46200036, 0xffe000ff, RD_2|RD_3|WR_CC|FP_D,   0,		I4_32,		0,	I37 },
{"c.ole.s",		"S,T",		0x46000036, 0xffe007ff, RD_1|RD_2|WR_CC|FP_S,   0,		I1,		0,	RSP|EE|I37 },
...
{"c.ule.d",		"S,T",		0x46200037, 0xffe007ff,	RD_1|RD_2|WR_CC|FP_D,	0,		I1,		0,	RSP|SF|I37 },
{"c.ule.d",		"M,S,T",	0x46200037, 0xffe000ff, RD_2|RD_3|WR_CC|FP_D,   0,		I4_32,		0,	I37 },
{"c.ule.s",		"S,T",		0x46000037, 0xffe007ff, RD_1|RD_2|WR_CC|FP_S,   0,		I1,		0,	RSP|EE|I37 },
...
{"c.sf.d",		"S,T",		0x46200038, 0xffe007ff,	RD_1|RD_2|WR_CC|FP_D,	0,		I1,		0,	RSP|SF|I37 },
{"c.sf.d",		"M,S,T",	0x46200038, 0xffe000ff, RD_2|RD_3|WR_CC|FP_D,   0,		I4_32,		0,	I37 },
{"c.sf.s",		"S,T",		0x46000038, 0xffe007ff, RD_1|RD_2|WR_CC|FP_S,   0,		I1,		0,	RSP|EE|I37 },
...
{"c.ngle.d",		"S,T",		0x46200039, 0xffe007ff,	RD_1|RD_2|WR_CC|FP_D,	0,		I1,		0,	RSP|SF|I37 },
{"c.ngle.d",		"M,S,T",	0x46200039, 0xffe000ff, RD_2|RD_3|WR_CC|FP_D,   0,		I4_32,		0,	I37 },
{"c.ngle.s",		"S,T",		0x46000039, 0xffe007ff, RD_1|RD_2|WR_CC|FP_S,   0,		I1,		0,	RSP|EE|I37 },
...
{"c.seq.d",		"S,T",		0x4620003a, 0xffe007ff,	RD_1|RD_2|WR_CC|FP_D,	0,		I1,		0,	RSP|SF|I37 },
{"c.seq.d",		"M,S,T",	0x4620003a, 0xffe000ff, RD_2|RD_3|WR_CC|FP_D,   0,		I4_32,		0,	I37 },
{"c.seq.s",		"S,T",		0x4600003a, 0xffe007ff, RD_1|RD_2|WR_CC|FP_S,   0,		I1,		0,	RSP|EE|I37 },
...
{"c.ngl.d",		"S,T",		0x4620003b, 0xffe007ff,	RD_1|RD_2|WR_CC|FP_D,	0,		I1,		0,	RSP|SF|I37 },
{"c.ngl.d",		"M,S,T",	0x4620003b, 0xffe000ff, RD_2|RD_3|WR_CC|FP_D,   0,		I4_32,		0,	I37 },
{"c.ngl.s",		"S,T",		0x4600003b, 0xffe007ff, RD_1|RD_2|WR_CC|FP_S,   0,		I1,		0,	RSP|EE|I37 },
...
{"c.lt.d",		"S,T",		0x4620003c, 0xffe007ff,	RD_1|RD_2|WR_CC|FP_D,	0,		I1,		0,	RSP|SF|I37 },
...
{"c.lt.s",		"S,T",		0x4600003c, 0xffe007ff,	RD_1|RD_2|WR_CC|FP_S,	0,		I1,		0,	RSP|EE|I37 },
...
{"c.nge.d",		"S,T",		0x4620003d, 0xffe007ff,	RD_1|RD_2|WR_CC|FP_D,	0,		I1,		0,	RSP|SF|I37 },
{"c.nge.d",		"M,S,T",	0x4620003d, 0xffe000ff, RD_2|RD_3|WR_CC|FP_D,   0,		I4_32,		0,	I37 },
{"c.nge.s",		"S,T",		0x4600003d, 0xffe007ff, RD_1|RD_2|WR_CC|FP_S,   0,		I1,		0,	RSP|EE|I37 },
...
{"c.le.d",		"S,T",		0x4620003e, 0xffe007ff,	RD_1|RD_2|WR_CC|FP_D,	0,		I1,		0,	RSP|SF|I37 },
...
{"c.le.s",		"S,T",		0x4600003e, 0xffe007ff,	RD_1|RD_2|WR_CC|FP_S,	0,		I1,		0,	RSP|EE|I37 },
...
{"c.ngt.d",		"S,T",		0x4620003f, 0xffe007ff,	RD_1|RD_2|WR_CC|FP_D,	0,		I1,		0,	RSP|SF|I37 },
{"c.ngt.d",		"M,S,T",	0x4620003f, 0xffe000ff, RD_2|RD_3|WR_CC|FP_D,   0,		I4_32,		0,	I37 },
{"c.ngt.s",		"S,T",		0x4600003f, 0xffe007ff, RD_1|RD_2|WR_CC|FP_S,   0,		I1,		0,	RSP|EE|I37 },
...
{"cfc1",		"t,g",		0x44400000, 0xffe007ff,	WR_1|RD_C1|LC,		0,		I1,		0,	RSP },
{"cfc1",		"t,S",		0x44400000, 0xffe007ff,	WR_1|RD_C1|LC,		0,		I1,		0,	RSP },
...
{"ctc1",		"t,g",		0x44c00000, 0xffe007ff,	RD_1|WR_CC|CM,		0,		I1,		0,	RSP },
{"ctc1",		"t,S",		0x44c00000, 0xffe007ff,	RD_1|WR_CC|CM,		0,		I1,		0,	RSP },
...
{"cvt.d.s",		"D,S",		0x46000021, 0xffff003f,	WR_1|RD_2|FP_S|FP_D,	0,		I1,		0,	RSP|SF },
{"cvt.d.w",		"D,S",		0x46800021, 0xffff003f,	WR_1|RD_2|FP_S|FP_D,	0,		I1,		0,	RSP|SF },
...
{"cvt.s.d",		"D,S",		0x46200020, 0xffff003f,	WR_1|RD_2|FP_S|FP_D,	0,		I1,		0,	RSP|SF },
{"cvt.s.w",		"D,S",		0x46800020, 0xffff003f,	WR_1|RD_2|FP_S,		0,		I1,		0,	RSP },
...
{"cvt.w.d",		"D,S",		0x46200024, 0xffff003f,	WR_1|RD_2|FP_S|FP_D,	0,		I1,		0,	RSP|SF },
{"cvt.w.s",		"D,S",		0x46000024, 0xffff003f,	WR_1|RD_2|FP_S,		0,		I1,		0,	RSP|EE },
...
{"div",			"z,s,t",	0x0000001a, 0xfc00ffff, RD_2|RD_3|WR_HILO,      0,		I1,		0,	RSP|I37 },
{"div",			"z,t",		0x0000001a, 0xffe0ffff, RD_2|WR_HILO,		0,		I1,		0,	RSP|I37 },
{"div",			"d,v,t",	0,    (int) M_DIV_3,	INSN_MACRO,		0,		I1,		0,	RSP|I37 },
{"div",			"d,v,I",	0,    (int) M_DIV_3I,	INSN_MACRO,		0,		I1,		0,	RSP|I37 },
{"div1",		"z,s,t",	0x7000001a, 0xfc00ffff, RD_2|RD_3|WR_HILO,      0,		EE,		0,	0 },
{"div1",		"z,t",		0x7000001a, 0xffe0ffff, RD_2|WR_HILO,		0,		EE,		0,	0 },
{"div.d",		"D,V,T",	0x46200003, 0xffe0003f,	WR_1|RD_2|RD_3|FP_D,	0,		I1,		0,	RSP|SF },
{"div.s",		"D,V,T",	0x46000003, 0xffe0003f,	WR_1|RD_2|RD_3|FP_S,	0,		I1,		0,	RSP },
...
{"divu",		"z,s,t",	0x0000001b, 0xfc00ffff, RD_2|RD_3|WR_HILO,      0,		I1,		0,	RSP|I37 },
{"divu",		"z,t",		0x0000001b, 0xffe0ffff, RD_2|WR_HILO,		0,		I1,		0,	RSP|I37 },
{"divu",		"d,v,t",	0,    (int) M_DIVU_3,	INSN_MACRO,		0,		I1,		0,	RSP|I37 },
{"divu",		"d,v,I",	0,    (int) M_DIVU_3I,	INSN_MACRO,		0,		I1,		0,	RSP|I37 },
...
{"l.d",			"T,A(b)",	0,    (int) M_L_DAB,	INSN_MACRO,		INSN2_M_FP_D,	I1,		0,	RSP },
...
{"li.d",		"t,F",		0,    (int) M_LI_D,	INSN_MACRO,		INSN2_M_FP_D,	I1,		0,	RSP|SF },
{"li.d",		"T,L",		0,    (int) M_LI_DD,	INSN_MACRO,		INSN2_M_FP_D,	I1,		0,	RSP|SF },
{"li.s",		"t,f",		0,    (int) M_LI_S,	INSN_MACRO,		INSN2_M_FP_S,	I1,		0,	RSP },
{"li.s",		"T,l",		0,    (int) M_LI_SS,	INSN_MACRO,		INSN2_M_FP_S,	I1,		0,	RSP },
...
{"lwc1",		"T,o(b)",	0xc4000000, 0xfc000000,	WR_1|RD_3|CLD|FP_S,	0,		I1,		0,	RSP },
{"lwc1",		"E,o(b)",	0xc4000000, 0xfc000000,	WR_1|RD_3|CLD|FP_S,	0,		I1,		0,	RSP },
{"lwc1",		"T,A(b)",	0,    (int) M_LWC1_AB,	INSN_MACRO,		INSN2_M_FP_S,	I1,		0,	RSP },
{"lwc1",		"E,A(b)",	0,    (int) M_LWC1_AB,	INSN_MACRO,		INSN2_M_FP_S,	I1,		0,	RSP },
{"l.s",			"T,o(b)",	0xc4000000, 0xfc000000,	WR_1|RD_3|CLD|FP_S,	0,		I1,		0,	RSP }, /* lwc1 */
{"l.s",			"T,A(b)",	0,    (int) M_LWC1_AB,	INSN_MACRO,		INSN2_M_FP_S,	I1,		0,	RSP },
...
{"lwc3",		"E,o(b)",	0xcc000000, 0xfc000000,	RD_3|WR_CC|CLD,		0,		I1,		0,	RSP|I3_32|EE|ALX },
{"lwc3",		"E,A(b)",	0,    (int) M_LWC3_AB,	INSN_MACRO,		0,		I1,		0,	RSP|I3_32|EE|ALX },
{"lwl",			"t,o(b)",	0x88000000, 0xfc000000,	WR_1|RD_3|LM,		0,		I1,		0,	RSP|I37 },
{"lwl",			"t,A(b)",	0,    (int) M_LWL_AB,	INSN_MACRO,		0,		I1,		0,	RSP|I37 },
{"lcache",		"t,o(b)",	0x88000000, 0xfc000000,	WR_1|RD_3|LM,		0,		I2,		0,	I37 }, /* same */
{"lcache",		"t,A(b)",	0,    (int) M_LWL_AB,	INSN_MACRO,		0,		I2,		0,	I37 }, /* as lwl */
{"lwr",			"t,o(b)",	0x98000000, 0xfc000000,	WR_1|RD_3|LM,		0,		I1,		0,	RSP|I37 },
{"lwr",			"t,A(b)",	0,    (int) M_LWR_AB,	INSN_MACRO,		0,		I1,		0,	RSP|I37 },
...
{"mfc1",		"t,S",		0x44000000, 0xffe007ff,	WR_1|RD_2|LC|FP_S,	0,		I1,		0,	RSP },
{"mfc1",		"t,G",		0x44000000, 0xffe007ff,	WR_1|RD_2|LC|FP_S,	0,		I1,		0,	RSP },
...
{"mfhi",		"d",		0x00000010, 0xffff07ff,	WR_1|RD_HI,		0,		I1,		0,	RSP|I37 },
...
{"mflo",		"d",		0x00000012, 0xffff07ff,	WR_1|RD_LO,		0,		I1,		0,	RSP|I37 },
...
{"mov.d",		"D,S",		0x46200006, 0xffff003f,	WR_1|RD_2|FP_D,		0,		I1,		0,	RSP|SF },
{"mov.s",		"D,S",		0x46000006, 0xffff003f,	WR_1|RD_2|FP_S,		0,		I1,		0,	RSP },
...
{"mtc1",		"t,S",		0x44800000, 0xffe007ff,	RD_1|WR_2|CM|FP_S,	0,		I1,		0,	RSP },
{"mtc1",		"t,G",		0x44800000, 0xffe007ff,	RD_1|WR_2|CM|FP_S,	0,		I1,		0,	RSP },
...
{"mthi",		"s",		0x00000011, 0xfc1fffff,	RD_1|WR_HI,		0,		I1,		0,	RSP|I37 },
...
{"mtlo",		"s",		0x00000013, 0xfc1fffff,	RD_1|WR_LO,		0,		I1,		0,	RSP|I37 },
...
{"mul.d",		"D,V,T",	0x46200002, 0xffe0003f,	WR_1|RD_2|RD_3|FP_D,	0,		I1,		0,	RSP|SF },
{"mul.s",		"D,V,T",	0x46000002, 0xffe0003f,	WR_1|RD_2|RD_3|FP_S,	0,		I1,		0,	RSP },
...
{"mul",			"d,v,t",	0,    (int) M_MUL,	INSN_MACRO,		0,		I1,		0,	RSP|I37 },
{"mul",			"d,v,I",	0,    (int) M_MUL_I,	INSN_MACRO,		0,		I1,		0,	RSP|I37 },
...
{"mulo",		"d,v,t",	0,    (int) M_MULO,	INSN_MACRO,		0,		I1,		0,	RSP|I37 },
{"mulo",		"d,v,I",	0,    (int) M_MULO_I,	INSN_MACRO,		0,		I1,		0,	RSP|I37 },
{"mulou",		"d,v,t",	0,    (int) M_MULOU,	INSN_MACRO,		0,		I1,		0,	RSP|I37 },
{"mulou",		"d,v,I",	0,    (int) M_MULOU_I,	INSN_MACRO,		0,		I1,		0,	RSP|I37 },
...
{"mult",		"s,t",		0x00000018, 0xfc00ffff, RD_1|RD_2|WR_HILO|IS_M, 0,		I1,		0,	RSP|I37 },
...
{"multu",		"s,t",		0x00000019, 0xfc00ffff, RD_1|RD_2|WR_HILO|IS_M, 0,		I1,		0,	RSP|I37 },
...
{"neg.d",		"D,V",		0x46200007, 0xffff003f,	WR_1|RD_2|FP_D,		0,		I1,		0,	RSP|SF },
{"neg.s",		"D,V",		0x46000007, 0xffff003f,	WR_1|RD_2|FP_S,		0,		I1,		0,	RSP },
...
{"rem",			"z,s,t",	0x0000001a, 0xfc00ffff, RD_2|RD_3|WR_HILO,      AL,		I1,		0,	RSP|I37 },
{"rem",			"d,v,t",	0,    (int) M_REM_3,	INSN_MACRO,		0,		I1,		0,	RSP|I37 },
{"rem",			"d,v,I",	0,    (int) M_REM_3I,	INSN_MACRO,		0,		I1,		0,	RSP|I37 },
{"remu",		"z,s,t",	0x0000001b, 0xfc00ffff, RD_2|RD_3|WR_HILO,      AL,		I1,		0,	RSP|I37 },
{"remu",		"d,v,t",	0,    (int) M_REMU_3,	INSN_MACRO,		0,		I1,		0,	RSP|I37 },
{"remu",		"d,v,I",	0,    (int) M_REMU_3I,	INSN_MACRO,		0,		I1,		0,	RSP|I37 },
...
{"s.d",			"T,A(b)",	0,    (int) M_S_DAB,	INSN_MACRO,		INSN2_M_FP_D,	I1,		0,	RSP },
...
{"sub.d",		"D,V,T",	0x46200001, 0xffe0003f,	WR_1|RD_2|RD_3|FP_D,	0,		I1,		0,	RSP|SF },
{"sub.s",		"D,V,T",	0x46000001, 0xffe0003f,	WR_1|RD_2|RD_3|FP_S,	0,		I1,		0,	RSP },
...
{"swc1",		"T,o(b)",	0xe4000000, 0xfc000000,	RD_1|RD_3|SM|FP_S,	0,		I1,		0,	RSP },
{"swc1",		"E,o(b)",	0xe4000000, 0xfc000000,	RD_1|RD_3|SM|FP_S,	0,		I1,		0,	RSP },
{"swc1",		"T,A(b)",	0,    (int) M_SWC1_AB,	INSN_MACRO,		INSN2_M_FP_S,	I1,		0,	RSP },
{"swc1",		"E,A(b)",	0,    (int) M_SWC1_AB,	INSN_MACRO,		INSN2_M_FP_S,	I1,		0,	RSP },
{"s.s",			"T,o(b)",	0xe4000000, 0xfc000000,	RD_1|RD_3|SM|FP_S,	0,		I1,		0,	RSP }, /* swc1 */
{"s.s",			"T,A(b)",	0,    (int) M_SWC1_AB,	INSN_MACRO,		INSN2_M_FP_S,	I1,		0,	RSP },
...
{"swc3",		"E,o(b)",	0xec000000, 0xfc000000,	RD_3|RD_C3|SM,		0,		I1,		0,	RSP|I3_32|EE|ALX },
{"swc3",		"E,A(b)",	0,    (int) M_SWC3_AB,	INSN_MACRO,		0,		I1,		0,	RSP|I3_32|EE|ALX },
{"swl",			"t,o(b)",	0xa8000000, 0xfc000000,	RD_1|RD_3|SM,		0,		I1,		0,	RSP|I37 },
{"swl",			"t,A(b)",	0,    (int) M_SWL_AB,	INSN_MACRO,		0,		I1,		0,	RSP|I37 },
{"scache",		"t,o(b)",	0xa8000000, 0xfc000000,	RD_1|RD_3,		0,		I2,		0,	I37 }, /* same */
{"scache",		"t,A(b)",	0,    (int) M_SWL_AB,	INSN_MACRO,		0,		I2,		0,	I37 }, /* as swl */
{"swr",			"t,o(b)",	0xb8000000, 0xfc000000,	RD_1|RD_3|SM,		0,		I1,		0,	RSP|I37 },
{"swr",			"t,A(b)",	0,    (int) M_SWR_AB,	INSN_MACRO,		0,		I1,		0,	RSP|I37 },
...
{"syscall",		"",		0x0000000c, 0xffffffff,	TRAP,			0,		I1,		0,	RSP },
{"syscall",		"B",		0x0000000c, 0xfc00003f,	TRAP,			0,		I1,		0,	RSP },
...
{"tlbp",		"",		0x42000008, 0xffffffff, INSN_TLB,       	0,		I1,		0,	RSP },
{"tlbr",		"",		0x42000001, 0xffffffff, INSN_TLB,       	0,		I1,		0,	RSP },
{"tlbwi",		"",		0x42000002, 0xffffffff, INSN_TLB,       	0,		I1,		0,	RSP },
{"tlbwr",		"",		0x42000006, 0xffffffff, INSN_TLB,       	0,		I1,		0,	RSP },
...
{"trunc.w.d",		"D,S,t",	0,    (int) M_TRUNCWD,	INSN_MACRO,		INSN2_M_FP_S|INSN2_M_FP_D, I1,	0,	RSP|SF },
...
{"trunc.w.s",		"D,S,t",	0,    (int) M_TRUNCWS,	INSN_MACRO,		INSN2_M_FP_S,	I1,		0,	RSP|EE },
...
{"vmulu",		"-X,-Y,-E",	0x4a000001, 0xfe00003f,	WR_1|RD_2|RD_3,		SPVU|LD3,	RSP,		0,	IOCT },
{"vmulu",		"d,v,t",	0x7000000f, 0xfc0007ff, WR_1|RD_2|RD_3,		0,		IOCT,		0,	RSP },
...
{"bc0f",		"p",		0x41000000, 0xffff0000,	RD_CC|CBD,		0,		I1,		0,	RSP|I4_32 },
{"bc0fl",		"p",		0x41020000, 0xffff0000,	RD_CC|CBL,		0,		I2|T3,		0,	I4_32 },
{"bc0t",		"p",		0x41010000, 0xffff0000,	RD_CC|CBD,		0,		I1,		0,	RSP|I4_32 },
...
{"cfc0",		"t,g",		0x40400000, 0xffe007ff,	WR_1|RD_C0|LC,		0,		I1,		0,	RSP|I32 },
{"ctc0",		"t,g",		0x40c00000, 0xffe007ff,	RD_1|WR_CC|CM,		0,		I1,		0,	RSP|I32 },
...
{"bc2f",		"p",		0x49000000, 0xffff0000,	RD_CC|CBD,		0,		I1,		0,	RSP|N54|IOCT|IOCTP|IOCT2|I37 },
...
{"bc2t",		"p",		0x49010000, 0xffff0000,	RD_CC|CBD,		0,		I1,		0,	RSP|N54|IOCT|IOCTP|IOCT2|I37 },
...
{"cfc2",		"t,-C",		0x48400000, 0xffe007ff, WR_1|RD_C2|LC,		0,		RSP,		0,	0 },
{"cfc2",		"t,-Y",		0x48400000, 0xffe007ff, WR_1|RD_C2|LC,		0,		RSP,		0,	0 },
...
{"ctc2",		"t,-C",		0x48C00000, 0xffe007ff, RD_1|WR_CC|CM,		0,		RSP,		0,	0 },
{"ctc2",		"t,-Y",		0x48C00000, 0xffe007ff, RD_1|WR_CC|CM,		0,		RSP,		0,	0 },
...
{"mfc2",		"t,-Y-e",	0x48000000, 0xffe0007f, WR_1|RD_C2|LC,		0,		RSP,		0,	0 },
...
{"mtc2",		"t,-Y-e",	0x48800000, 0xffe0007f, RD_1|WR_C2|WR_CC|CM,	LD3,		RSP,		0,	0 },
...
/* Coprocessor 3 move/branch operations overlap with MIPS IV COP1X
   instructions, so they are here for the latters to take precedence.  */
{"bc3f",		"p",		0x4d000000, 0xffff0000,	RD_CC|CBD,		0,		I1,		0,	RSP|I3_33|EE|ALX },
{"bc3fl",		"p",		0x4d020000, 0xffff0000,	RD_CC|CBL,		0,		I2|T3,		0,	I3_33|EE|ALX },
{"bc3t",		"p",		0x4d010000, 0xffff0000,	RD_CC|CBD,		0,		I1,		0,	RSP|I3_33|EE|ALX },
{"bc3tl",		"p",		0x4d030000, 0xffff0000,	RD_CC|CBL,		0,		I2|T3,		0,	I3_33|EE|ALX },
{"cfc3",		"t,g",		0x4c400000, 0xffe007ff,	WR_1|RD_C3|LC,		0,		I1,		0,	RSP|I3_33|EE|ALX },
{"ctc3",		"t,g",		0x4cc00000, 0xffe007ff,	RD_1|WR_CC|CM,		0,		I1,		0,	RSP|I3_33|EE|ALX },
{"mfc3",		"t,G",		0x4c000000, 0xffe007ff,	WR_1|RD_C3|LC,		0,		I1,		0,	RSP|I3_33|EE|ALX },
{"mfc3",		"t,G,H",	0x4c000000, 0xffe007f8,	WR_1|RD_C3|LC,		0,		I32,		0,	I3_33|EE|ALX },
{"mtc3",		"t,G",		0x4c800000, 0xffe007ff,	RD_1|WR_C3|WR_CC|CM,	0,		I1,		0,	RSP|I3_33|EE|ALX },
...
{"c1",			"C",		0x46000000, 0xfe000000,	FP_S,			0,		I1,		0,	RSP },
{"c2",			"C",		0x4a000000, 0xfe000000,	CP,			0,		I1,		0,	N54|IOCT|IOCTP|IOCT2 },
{"c3",			"C",		0x4e000000, 0xfe000000,	CP,			0,		I1,		0,	RSP|I3_33 },
{"cop0",		"C",		0,    (int) M_COP0,	INSN_MACRO,		0,		I1,		0,	IOCT|IOCTP|IOCT2 },
{"cop1",		"C",		0,    (int) M_COP1,	INSN_MACRO,		INSN2_M_FP_S,	I1,		0,	RSP },
{"cop2",		"C",		0,    (int) M_COP2,	INSN_MACRO,		0,		I1,		0,	N54|IOCT|IOCTP|IOCT2 },
{"cop3",		"C",		0,    (int) M_COP3,	INSN_MACRO,		0,		I1,		0,	RSP|I3_33 },
};
